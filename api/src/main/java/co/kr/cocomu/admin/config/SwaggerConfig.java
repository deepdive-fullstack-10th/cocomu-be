...
public class SwaggerConfig {
    ...
    private static final String SERVER_DESCRIPTION = "COCOMU API";
    private static final String DOCS_TITLE = "COCOMU API";
    private static final String DOCS_VERSION = "v1.0.0";
    private static final String DOCS_DESCRIPTION = "코코무 API 문서";

    private final String devUrl;

    public SwaggerConfig(@Value("${admin.swagger.url}") final String dveUrl) {
        this.devUrl = dveUrl;
    }
